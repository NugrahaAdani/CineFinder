...
export default function MovieList(){
    ...
    return (
        <>
            <div className="min-h-screen w-full bg-black py-6">
                ...
                <div className="mx-10 mt-6 grid grid-cols-1 gap-2 gap-y-4 justify-items-center sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
                    {movies.map((movie) => {
                        ...
                        return (
                            <article
                                key={movie.id}
                                className="relative aspect-2/3 w-full max-w-58 overflow-hidden rounded-xl bg-zinc-900 shadow-lg transition-all duration-300 hover:-translate-y-2"
                                >
                                {movie.poster_path ? (
                                    <img
